...
sudo cp unbound_blocklist.conf "/opt/unbound/etc/unbound/unbound_blocklist.conf"
sleep 0.1
...
sudo cp unbound_whitelist.conf "/opt/unbound/etc/unbound/unbound_whitelist.conf"
sleep 0.1
echo -e " ${TICK} \e[32m Cleanup old resources... \e[0m"
rm whitelist.txt
